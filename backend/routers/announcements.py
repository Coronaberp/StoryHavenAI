...
async def admin_announce(payload: AnnounceIn, current_user: dict = Depends(require_capability(
        "announcements.post", "Post a site announcement or send a targeted notification."))):
...
async def admin_generate_toned_notification(payload: AdminToneGenerateIn, current_user: dict = Depends(require_capability(
        "announcements.post", "Post a site announcement or send a targeted notification."))):
...
async def admin_send_targeted_notification(payload: AdminTargetedNotifyIn, current_user: dict = Depends(require_capability(
        "announcements.post", "Post a site announcement or send a targeted notification."))):
...
async def set_site_banner(payload: SiteBannerIn, current_user: dict = Depends(require_capability(
        "announcements.set_banner", "Set or clear the site banner."))):
...
async def clear_site_banner(current_user: dict = Depends(require_capability(
        "announcements.set_banner", "Set or clear the site banner."))):
