...
async def set_checkpoint_meta_route(name: str, body: ModelMetaIn,
                                    current_user: dict = Depends(require_capability("model_previews.edit", "Edit preview metadata, thumbnails, or NSFW flags."))):
...
async def clear_checkpoint_preview_nsfw(name: str, current_user: dict = Depends(require_capability("model_previews.edit", "Edit preview metadata, thumbnails, or NSFW flags."))):
...
async def clear_checkpoint_preview(name: str, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
    old = await checkpoints.get_preview(name)
    if old:
        _delete_media_file(old.split("?")[0])
...
async def publish_lora_route(name: str, body: LoraPublishIn, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
...
async def clear_lora_preview_nsfw(name: str, current_user: dict = Depends(require_capability("model_previews.edit", "Edit preview metadata, thumbnails, or NSFW flags."))):
...
async def clear_lora_preview(name: str, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
...
async def delete_model_file(kind: str, name: str, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
...
async def clear_sampler_preview(name: str, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
...
async def clear_scheduler_preview(name: str, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
...
async def clear_upscaler_preview(name: str, current_user: dict = Depends(require_capability("model_previews.delete", "Delete a preview or model file, or publish a LoRA preview."))):
