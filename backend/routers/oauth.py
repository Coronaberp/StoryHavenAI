...
from backend.auth import get_current_user, require_capability, _free_guest_username, _issue_tokens, _set_auth_cookies
...
async def admin_list_oauth_providers(current_user: dict = Depends(require_capability(
        "system_settings.view", "View OAuth provider configuration."))):
