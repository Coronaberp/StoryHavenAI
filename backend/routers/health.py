...
async def admin_service_health_refresh(_: dict = Depends(require_capability(
        "service_health.refresh", "Force a service health refresh."))):
...
async def admin_service_health(hours: float = 24, _: dict = Depends(require_capability(
