...
# cancelling in-flight chat generation and, once, colliding with a startup
# ALTER TABLE migration and crashing the app outright. This MUST be the bare
# directory, not a glob like '.claude/worktrees/*' — uvicorn's FileFilter
